...
def main():
    with sync_playwright() as p:
        # channel="chrome" uses your machine's real, actual Chrome install
        # instead of Playwright's bundled test Chromium — Google's sign-in
        # blocks the test build but generally allows real Chrome.
